...
export default class Auth {
  ...
  login = () => {
    // authorize is a method available on the auth0.WebAuth object, it redirects the user to the login page and handles that entire logging in process and sends them back to the callback URL
