...
module.exports = function(app) {
  ...
  app.post('/api/getDrug', function(req, res) {
    ...
    unirest
      .get(
        'https://iterar-mapi-us.p.rapidapi.com/api/autocomplete?query=' +
          req.body.name
      )
      .header(
        'X-RapidAPI-Key',
  ...
  app.post('/api/interaction', function(req, res) {
    ...
    var drugCombo =
      req.body.name1 + '-' + req.body.name2 + '-' + req.body.email;
    console.log(drugCombo);
    db.Drug.create({
      drugname1: req.body.name1,
      drugname2: req.body.name2,
      drugCombo,
